...
@section('content')
    <div style="background-color: white;">
        <h2 class="text-center mb-1" style="color:#AC0202; font-size:1.8rem;">Haz tu reservación</h2>
            ...
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('reservas.store') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group" style="display:none;">
                        <label for="receta_id" style="font-size:1.5rem;" style="display:none;">Mi reservación</label>

                        <input style="font-size:1.5rem;" type="text" style="display:none;"
                            name="receta_id"
                            class="form-control @error('receta_id') is-invalid @enderror "
                            id="receta_id"
                            placeholder="{{ $receta->id }}"
                            value={{ $receta->id }}
                        >
                    ...
                    <div class="form-group" style="display:none;">
                        <label for="user_id" style="font-size:1.5rem;" style="display:none;">Mi reservación</label>
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn-primary" value="Reservar" style="width:100%; padding-top:0.5rem;font-size:1.5rem;" >
                    </div>
